...
# 设置包含CSV文件的文件夹路径
folder_path = "/Users/lxj/PycharmProjects/OA/TuRBOIbea_LLM/Results/1-plt/movie"  # 请替换为实际的文件夹路径
# algorithm_names = {
#     # 请根据您的实际文件名修改下面的映射
...
if not algorithm_data:
    ...
    # 加粗3D图的坐标轴标签和标题
    ax1.set_xlabel('Acc', fontweight='bold', fontsize=12)
    ax1.set_ylabel('Div', fontweight='bold', fontsize=12)
    ax1.set_zlabel('Fair', fontweight='bold', fontsize=12)
    ax1.set_title('3D Pareto Front Comparison', fontweight='bold', fontsize=14)
    ...
    # 加粗刻度标签
    ax1.tick_params(axis='both', which='major', width=1.5, labelsize=10)
    ...
    # 加粗2D图的坐标轴标签和标题
    ax2.set_xlabel('Acc', fontweight='bold', fontsize=12)
    ax2.set_ylabel('Div', fontweight='bold', fontsize=12)
    ...
    # 加粗刻度
    ax2.tick_params(axis='both', which='major', width=1.5, labelsize=10)
    ...
    # 加粗2D图的坐标轴标签和标题
    ax3.set_xlabel('Acc', fontweight='bold', fontsize=12)
    ax3.set_ylabel('Fair', fontweight='bold', fontsize=12)
    ...
    # 加粗刻度
    ax3.tick_params(axis='both', which='major', width=1.5, labelsize=10)
    ...
    # 加粗2D图的坐标轴标签和标题
    ax4.set_xlabel('Div', fontweight='bold', fontsize=12)
    ax4.set_ylabel('Fair', fontweight='bold', fontsize=12)
    ...
    # 加粗刻度
    ax4.tick_params(axis='both', which='major', width=1.5, labelsize=10)
    ...
    # 加粗平行坐标图的坐标轴标签和标题
    ax5.set_xlabel('Objectives', fontweight='bold', fontsize=12)
    ...
    # 加粗刻度
    ax5.tick_params(axis='both', which='major', width=1.5, labelsize=10)

    ax5.set_xticks([0, 1, 2])
    ax5.set_xticklabels(objectives_names, fontweight='bold')
