...
for setting in config.DATA_OBJECTIVES:
    ...
    detailed_dir, compatibility_path = config.get_save_path(
        "IBEA-LLM", dataset, objectives, config.SEED
    )
...
# 保存时间记录
time_file = f"{config.RESULTS_BASE_DIR}/TimeConsumption_IBEA-LLM_Seed_{config.SEED}.pkl"
try:
